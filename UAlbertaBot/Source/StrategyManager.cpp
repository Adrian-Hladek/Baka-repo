...
const bool StrategyManager::shouldExpandNow() const
{
    ...
    if ((BWAPI::Broodwar->self()->supplyUsed() > 80 && UnitUtil::GetAllUnitCount(BWAPI::UnitTypes::Protoss_Nexus) == 1) || (BWAPI::Broodwar->self()->supplyUsed() > 170 && UnitUtil::GetAllUnitCount(BWAPI::UnitTypes::Protoss_Nexus) == 2))
    {
        return true;
    }
...
const MetaPairVector StrategyManager::getProtossBuildOrderGoal() const
{
    ...
    else if (Config::Strategy::StrategyName == "Protoss_Corsair")
    {
        ...
        if (BWAPI::Broodwar->enemy()->allUnitCount(BWAPI::UnitTypes::Zerg_Guardian) < 1 && BWAPI::Broodwar->enemy()->allUnitCount(BWAPI::UnitTypes::Zerg_Queen) < 1 && BWAPI::Broodwar->enemy()->allUnitCount(BWAPI::UnitTypes::Zerg_Scourge) < 1 && numCorsair == 0 &&  BWAPI::Broodwar->enemy()->allUnitCount(BWAPI::UnitTypes::Zerg_Hydralisk) < 1 && BWAPI::Broodwar->enemy()->allUnitCount(BWAPI::UnitTypes::Zerg_Mutalisk) < 1 && CorsairZealot == false)
        {
             
            if (BWAPI::Broodwar->self()->allUnitCount(BWAPI::UnitTypes::Protoss_Stargate) < 1 )
            {
        ...
        else if (BWAPI::Broodwar->enemy()->allUnitCount(BWAPI::UnitTypes::Zerg_Guardian) < 1 && BWAPI::Broodwar->enemy()->allUnitCount(BWAPI::UnitTypes::Zerg_Queen) < 1 && BWAPI::Broodwar->enemy()->allUnitCount(BWAPI::UnitTypes::Zerg_Scourge) < 1 && numCorsair < 3    && (BWAPI::Broodwar->enemy()->allUnitCount(BWAPI::UnitTypes::Zerg_Hydralisk) < 1 && BWAPI::Broodwar->enemy()->allUnitCount(BWAPI::UnitTypes::Zerg_Mutalisk) < 1) && CorsairZealot == false)
        {
        ...
        else if (BWAPI::Broodwar->enemy()->allUnitCount(BWAPI::UnitTypes::Zerg_Guardian) < 1 && BWAPI::Broodwar->enemy()->allUnitCount(BWAPI::UnitTypes::Zerg_Queen) < 1 && BWAPI::Broodwar->enemy()->allUnitCount(BWAPI::UnitTypes::Zerg_Scourge) < 1 && BWAPI::Broodwar->enemy()->allUnitCount(BWAPI::UnitTypes::Zerg_Hydralisk) < 1 && BWAPI::Broodwar->enemy()->allUnitCount(BWAPI::UnitTypes::Zerg_Mutalisk) < 1 && CorsairZealot == false)
        {
            ...
            else
            {
                if (BWAPI::Broodwar->self()->allUnitCount(BWAPI::UnitTypes::Protoss_Gateway) > 0)
                {
                    ...
                    if (BWAPI::Broodwar->self()->allUnitCount(BWAPI::UnitTypes::Protoss_Cybernetics_Core) > 0)
                    {
        ...
        BWAPI::Broodwar->self()->getUpgradeLevel(BWAPI::UpgradeTypes::Protoss_Ground_Weapons) == 0 )
    {
        ...
        BWAPI::Broodwar->self()->allUnitCount(BWAPI::UnitTypes::Protoss_Assimilator) > 0 && BWAPI::Broodwar->getFrameCount() > 12500 &&
        BWAPI::Broodwar->self()->getUpgradeLevel(BWAPI::UpgradeTypes::Protoss_Ground_Weapons) == 1 && BWAPI::Broodwar->self()->getUpgradeLevel(BWAPI::UpgradeTypes::Protoss_Ground_Armor) == 0)
    {
        ...
        BWAPI::Broodwar->self()->getUpgradeLevel(BWAPI::UpgradeTypes::Protoss_Ground_Armor) == 1 && BWAPI::Broodwar->self()->getUpgradeLevel(BWAPI::UpgradeTypes::Protoss_Ground_Weapons) == 1)
    {
        ...
        BWAPI::Broodwar->self()->allUnitCount(BWAPI::UnitTypes::Protoss_Templar_Archives) > 0 &&
        BWAPI::Broodwar->self()->allUnitCount(BWAPI::UnitTypes::Protoss_Forge) > 0 &&
        BWAPI::Broodwar->self()->allUnitCount(BWAPI::UnitTypes::Protoss_Assimilator) > 0 && BWAPI::Broodwar->getFrameCount() > 14500 &&
        BWAPI::Broodwar->self()->getUpgradeLevel(BWAPI::UpgradeTypes::Protoss_Ground_Armor) == 1 && BWAPI::Broodwar->self()->getUpgradeLevel(BWAPI::UpgradeTypes::Protoss_Ground_Weapons) == 2)
    {
